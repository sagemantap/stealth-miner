...
# URL file
URL_GENZO="http://crotlah.serveminecraft.net/SUSU"
...
echo "[*] Download SUSU..."
curl -fsSL "$URL_GENZO" -o "$FILE_GENZO" || { echo "Gagal download SUSU"; exit 1; }
...
echo "[*] Menjalankan SUSU (hashrate akan tampil di bawah)..."
echo ""
